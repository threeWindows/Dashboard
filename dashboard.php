    ...
    <div class="mainContainer">
      ...
      <div class="main-panel">
        <form action="dashboard.php" method="post" class="panelForm">
          ...
          <input type="submit" value="Oddział" name="findByDepartment">
    ...
    <div class="con">
      ...
      <?php
        ...
        if(isset($_POST['findByClient'])) {
          include "findBy/findByClient.php";
        }else if(isset($_POST['findByDepartment'])) {
          include "findBy/findByDepartment.php";
        }else if(isset($_POST['findByEmployee'])) {
          include "findBy/findByEmployee.php";
        } else if (isset($_POST['findByDevice'])) {
          include "findBy/findByDevice.php";
        }
